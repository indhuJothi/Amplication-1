...
import { MyProjectFindManyArgs } from "../../myProject/base/MyProjectFindManyArgs";
...
export class UserControllerBase {
  ...
  async findManyMyProjects(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<MyProject[]> {
    const query = plainToClass(MyProjectFindManyArgs, request.query);
    const permission = this.rolesBuilder.permission({
      role: userRoles,
      action: "read",
      possession: "any",
    ...
    const results = await this.service.findMyProjects(params.id, {
      ...query,
      select: {
        createdAt: true,
        date: true,
  ...
  @common.Post("/:id/myProjects")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async createMyProjects(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Delete("/:id/myProjects")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async deleteMyProjects(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: UserWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
